...
def init_database(test_app):
    with test_app.app_context():
        ...
        sender = Users(login='sender', password=generate_password_hash('test'), user_type='teacher', email='sender@test.com', phone_nr=111111111, photo="sender.jpg", logged_in=False)
        receiver = Users(login='receiver', password=generate_password_hash('test'), user_type='student', email='receiver@test.com', phone_nr=222222222, photo="receiver.jpg", logged_in=False)
